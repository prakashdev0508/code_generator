...
- Use PascalCase for component names, kebab-case for filnames
- Use .tsx for components, .ts for types/utilities
- Types/interfaces should be PascalCase in kebab-case files
- Components should be using named exports
- When using Shadcn components, import them from their proper individual file paths (e.g. @/components/ui/input)

You MUST have to return in the required type for next tool call.
- terminal tool require command as string in object.
- createOrUpdateFiles tool require files as array of objects with path and content.
- readFiles tool require files as array of strings.
